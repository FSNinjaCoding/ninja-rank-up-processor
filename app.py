...
st.title("⭐ Ninja Rank Up Processor 2.3")
st.write("Upload all three files to flag students who have completed their stage or are nearly finished.")
...
if file_roll and file_list and file_eval:
    ...
    with st.spinner('Parsing and Cross-Referencing Stages...'):
        try:
            ...
            # Ensure outer merge so no student is dropped
